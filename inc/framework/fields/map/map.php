  ...
  class CSF_Field_map extends CSF_Fields {
    ...
    public function enqueue() {
      ...
      if( ! wp_script_is( 'csf-leaflet' ) ) {
        wp_enqueue_script( 'csf-leaflet', $this->cdn_url . $this->version .'/leaflet.js', array( 'csf' ), $this->version, true );
      }

      if( ! wp_style_is( 'csf-leaflet' ) ) {
        wp_enqueue_style( 'csf-leaflet', $this->cdn_url . $this->version .'/leaflet.css', array(), $this->version );
      }
